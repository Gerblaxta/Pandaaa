  ...
  try {
    if (!args[0]) {
      const embed = new Discord.RichEmbed()
				...
				.addField('Want to invite me to your Discord?', '[Click here to invite me to your server.](https://discord.com/oauth2/authorize?client_id=719863691801264139&scope=bot&permissions=1)')
				.addField('Need more assistance?', '[Click here to join the official Pandaaa support server (Coming soon)]')
